...
{
    ?>
    <link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo('wpurl'); ?>/wp-content/plugins/th0ths_quotes/th0ths_quotes.css" />
    <?php
}
...
function th0ths_quotes_manage_quotes()
{
    ...
    <div class="wrap">
		<table id="th0ths_quotes_qlist" class="widefat">
			<thead>
				<tr>
					<th class="deleteLink">Delete</th>
					<th>Quote</th>
					<th>Owner</th>
				</tr>
				<?php foreach ($quotes as $quote) { ?>
				<tr>
					<td class="deleteLink"><a href="<?php echo add_query_arg(array('action' => 'delete', 'id' => $quote['id'])); ?>">[x]</a></td>
...
/* add plugin stylesheet to wp_head */
