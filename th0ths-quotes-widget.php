    ...
    function widget($args, $instance) {
        ...
        ?>
              <?php echo $before_widget; ?>
                  ...
                  <div id="th0ths_quotes_widget_quote" style="font-style: oblique;"><?php echo stripslashes($quote['quote']); ?></div>
                  <div id="th0ths_quotes_widget_owner" style="text-align: right;">
                      <?php if (th0ths_quotes_is_valid_source($quote['source'])) { ?><a href="<?php echo $quote['source']; ?>" target="_blank">-<?php echo stripslashes($quote['owner']); ?></a>
                      <?php } else  { ?>
                      -<?php echo stripslashes($quote['owner']); } ?>
                  </div>
