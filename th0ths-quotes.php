...
$th0ths_quotes_plugin_version = '2.01';
		...
		if ($_POST['action'] == 'Submit')
		{
			...
			{            
				...
				<div class="wrap">
					...
					<p><?php _e("Quote is successfully updated.", 'th0ths-quotes'); ?></p>
					<div class="th0ths_quotes_cleanser"></div>
					<p><?php printf(__('Click %shere%s to go to quote management page.', 'th0ths-quotes'), '<a href="admin.php?page=th0ths-quotes">' ,'</a>', '<a href="admin.php?page=th0ths-quotes-add-new">', '</a>'); ?></p>
				</div>
				<?php
			}
		}
...
function th0ths_quotes_options() {
	...
	$current_options = get_option('th0ths_quotes_options');
	...
	if ( empty($_POST) ) {
		...
		<div class="wrap" id="th0ths_movie_collection_options">
			...
			<form method="post">
			<h3><?php _e("Social Media Integration"); ?></h3>
			<table class="form-table">
			<tbody>
				<h4><?php _e("Twitter"); ?></h4>
				<tr>
					<th><label><?php _e("Enable Twitter button"); ?></label></th>
					<td>
						<select name="twitter_enabled" class="th0ths_quotes_select_bool">
							<option value="yes"<?php if ( $current_options['twitter']['enabled'] ) {?> selected="selected" <?php } ?>><?php _e("Yes"); ?></option>
							<option value="no"<?php if ( !$current_options['twitter']['enabled'] ) {?> selected="selected" <?php } ?>><?php _e("No"); ?></option>
						</select>
					</td>
				</tr>
				<tr>
					<th><label><?php _e("Show count on button"); ?></label></th>
					<td>
						<select name="twitter_show_count" class="th0ths_quotes_select_bool">
							<option value="yes"<?php if ( $current_options['twitter']['show_count'] ) {?> selected="selected" <?php } ?>><?php _e("Yes"); ?></option>
							<option value="no"<?php if ( !$current_options['twitter']['show_count'] ) {?> selected="selected" <?php } ?>><?php _e("No"); ?></option>
						</select>
					</td>
				</tr>
				<tr>
					<th><label><?php _e("Via"); ?></label></th>
					<td>
						<input name="twitter_via" type="text" value="<?php echo $current_options['twitter']['via']; ?>" />
						<span class="description"><?php _e("@yourtwitterusername Leave empty if you don't want to use."); ?></span>
					</td>
				</tr>
				<tr>
					<th><label><?php _e("Hashtag"); ?></label></th>
					<td>
						<input name="twitter_hashtag" type="text" value="<?php echo $current_options['twitter']['hashtag']; ?>" />
						<span class="description"><?php _e("Leave empty if you don't want an hashtag."); ?></span>
					</td>
				</tr>
			</tbody>
			</table>
		...
		<div class="wrap">
			...
			<p><?php _e("Options updated successfully.", 'th0ths-quotes'); ?></p>
			<div class="th0ths_quotes_cleanser"></div>
			<p><?php printf(__('Click %shere%s to go to quote management page.', 'th0ths-quotes'), '<a href="admin.php?page=th0ths-quotes">' ,'</a>', '<a href="admin.php?page=th0ths-quotes-add-new">', '</a>'); ?></p>
		</div>
		<?php
